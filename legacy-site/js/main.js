...
const servicesData = {
    ...
    ai: {
        ...
        desc: 'The AI revolution is here, and businesses that don\'t adapt will be left behind. We implement state-of-the-art AI solutions—from intelligent customer support agents and predictive data models to automated content generation workflows. We fine-tune Large Language Models (LLMs) and deploy Robotic Process Automation (RPA) to slash your overhead costs by up to 80% while multiplying your output.',
        features: [
